...
void emitSHABBullet(enemy_t* enemy,float angle)
{
	...
	bullet->ss_boudaries[UP] = bullet->ss_starting_boudaries[UP] = enemy->ss_position[Y] * SS_H + SHAB_BULLET_SIZE /2 * SS_H / gVScale;
	bullet->ss_boudaries[DOWN] = bullet->ss_starting_boudaries[DOWN] = enemy->ss_position[Y] * SS_H - SHAB_BULLET_SIZE /2 * SS_H / gVScale;
