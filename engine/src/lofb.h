...
// side stops firing the BIG ENERGY SHOTS (the -50% attack; both arms down
// cancels it). The homing seekers fire from the body and are not affected.
// Both functions used by collisions.c.
